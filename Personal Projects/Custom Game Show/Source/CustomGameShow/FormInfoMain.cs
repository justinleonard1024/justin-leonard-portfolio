...
{
    public partial class FormInfoMain : Form
    {
        /*
         * Constructor
         */
        ...
        private void FormInfoMain_KeyDown(object sender, KeyEventArgs e)
        {
            // Get click event
            switch (e.KeyCode)
            {
        ...
        {
            // Variables
            Form tempForm = new FormInfoRules();
        ...
        {
            // Variables
            Form tempForm = new FormInfoMedia();
        ...
        {
            // Variables
            Form tempForm = new FormInfoCustom();
